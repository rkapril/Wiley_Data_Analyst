 ...
 ?asia         
      ...
      ##  ---------------------------------
          ...
          ##  ---------------------------------------------------------------------
              ...
              model1_hc_modified <- set.arc(model1_hc, 
                                            from = "A", to ="T")
    ...
    ##  --------------------
            ...
            cpquery(model1_fit, event=(X=="yes"), 
                    evidence = (A=="yes")) #[1] 0.2222222
            ...
            cpquery(model1_fit, event=(L=="yes"), 
                    evidence = (S=="yes")) #[1] 0.121521
            ## Comment:
    ...
    ##    draws in the sampling procedure by using the tuning parameter, n (but takes longer time)
            set.seed(1)
            cpquery(model1_fit, event=(E=="yes"), 
                    evidence = (S=="yes")) 
            cpquery(model1_fit, event=(E=="yes"), 
                    evidence = (S=="yes"), n=10000000) #[1] 0.1257425
            cpquery(model1_fit, event=(E=="yes"), 
                    evidence = (S=="yes"), n=10000000) #[1] 0.1256002
            # ?cpquery
