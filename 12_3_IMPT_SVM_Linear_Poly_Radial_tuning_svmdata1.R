...
##  -----------------
    ...
    nonlineardata <- read.csv("../../Courses/Gen Infiniti Academy Pte Ltd/S4/Andy/svm_data1.csv", 
                              header=T, 
...
##  ------------------
    ...
    ggplot(data=nonlineardata, 
           aes(x=x2, y = x1, 
               color=factor(y))) + geom_point()
...
##  -----------------------------------------    
    ...
    set.seed(123)
    index <- sample(nrow(nonlineardata), 
                    round(0.8*(nrow(nonlineardata))))
