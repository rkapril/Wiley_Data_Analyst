...
##  ================================================
  ...
  ## () -- used in commands (e.g. sum(), is.na(), mean())
...
##  (1b) "for" loop (in specific sequence)
##  -----------------------------------------
...
##  -------------------------------------------------
      ...
      length(marks)  #[1] 3 (nrow() for dataframes; length() for vectors)
