...
##  enter name in console and hit ENTER; and then run last line.
    paste(g,yourname)
...
##  ------------------------------
    ...
    words   # [1] "The"   "quick" "brown" "fox"   "jumps" "over"  "the"   "lazy"  "dog"
    ...
    match(c("quick", "fox"), words) #[1] 2 4
    
    tail(words)    #[1] "fox"   "jumps" "over"  "the"   "lazy"  "dog"
    tail(words,1)  #[1] "dog"
    head(words)    #[1] "The"   "quick" "brown" "fox"   "jumps" "over" 
    head(words,1)  #[1] "The"
