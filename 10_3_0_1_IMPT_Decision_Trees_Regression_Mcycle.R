...
##  ==================================
    ...
    ##  --------------------------------------------------------------
        ...
        # 1 0.344868      0   1.00000 1.01233 0.142128
        # 2 0.035941      2   0.31026 0.41455 0.067148
        # 3 0.035764      3   0.27432 0.38791 0.058310
        # 4 0.014024      4   0.23856 0.33420 0.060873
        # 5 0.010000      6   0.21051 0.32346 0.062526
      # *Comment:
        ##      - nsplit    -- splitting nodes
        ##      - rel error -- relative error corresponds to the error in training set, decreases with no. of splits
        ##                      prediction accuracy is = 1 - 0.21051 (last node) = about 80% (aka R-squared)
        ##      - cp        -- complexity parameter is how much error is being reduced.
        ##                      e.g. after first split, error is being reduced from 1 to 0.655132 = 0.344868
...
##  -----------------------------------
      ...
      ##Alternatively:
        ## . If however, we are satisfied with xerror of 0.33420 (instead of 0.32346), then we can prune
        ##   by extracting the cp value (0.014024)
